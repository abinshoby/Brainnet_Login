...
function buildLoginPage(req, resp, error_message) {
    ...
    var login_form = "<h1 id='ti'>LOGIN</h1>";
   ...
   login_form += "<form  id='f' method='post' action='/check-login'>" +
        "<div id='usrl'>User Name :</div> <input type='text' id='usr' name='user_name' value='{user_name}'/><br/><br/>" +
        "<div id='pasl' >Password :</div><input type='password' id='pass' name='password' value='{password}'/><br/><br/>" +
